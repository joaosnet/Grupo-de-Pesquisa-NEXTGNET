...
public class TSP {
	...
	/************************************************************************************************************/
	/**
	 * Calcule a rota mais curta usando o algoritmo de força bruta
	 */
	public static void bruteForce() {
		...
		// permuteOutput the number of permutations generated
	...
	/**
	 * é um algoritmo simples que armazena todos os casos 
         * disponíveis e classifica os novos dados ou caso com base em uma medida de similaridade.
	 */
...
O método de Ramificar e limitar é um algoritmo para encontrar soluções ótimas para vários problemas de otimização, 
* especialmente em otimização combinatória.
	 */
